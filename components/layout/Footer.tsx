            ...
            <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li><Link href="/sobre" className="text-zinc-400 hover:text-primary transition-colors text-sm">Sobre a Empresa</Link></li>
                        <li><Link href="/servicos" className="text-zinc-400 hover:text-primary transition-colors text-sm">Nossos Serviços</Link></li>
                        <li><Link href="/frota" className="text-zinc-400 hover:text-primary transition-colors text-sm">Frota & Equipamentos</Link></li>
                        <li><Link href="/infraestrutura" className="text-zinc-400 hover:text-primary transition-colors text-sm">Projetos de Infraestrutura</Link></li>
                        <li><Link href="/contactos" className="text-zinc-400 hover:text-primary transition-colors text-sm">Fale Connosco</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li className="text-zinc-400 text-sm">Transporte de Betume</li>
                        <li className="text-zinc-400 text-sm">Logística de Obras</li>
                        <li className="text-zinc-400 text-sm">Transporte Pesado</li>
                        <li className="text-zinc-400 text-sm">Apoio Industrial</li>
                        <li className="text-zinc-400 text-sm">Materiais de Construção</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-6">
                        <li className="flex gap-4">
                            ...
                            <span className="text-zinc-400 text-sm">{siteConfig.address.line1}<br />{siteConfig.address.line2}</span>
                        </li>
                        <li className="flex gap-4">
                        ...
                        <li className="flex gap-4">
                            ...
                            <span className="text-zinc-400 text-sm">{siteConfig.contact.email.geral}</span>
                        </li>
                    </ul>
                </div>
            </div>
